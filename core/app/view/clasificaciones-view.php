				...
				<div class="col-12">
					...
					<div class="card">
						<div class="card-header">
							<h1 class="">Clasificaciones de Documentos</h1> <?php //$prueba = Core::$user->name; echo $prueba; 
																			?>
							<a href="./?view=clasificaciones&opt=new" class="btn btn-secondary">Nueva Clasificacion</a>
						</div>
						<div class="card-body">
