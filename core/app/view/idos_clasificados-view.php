											...
											<tr>
												...
												<td><?php
													if ($con->clasificacion == 33) {
														echo $con->descripcion . " <span class='badge bg-danger'> Sin clasificar </span>";
													} else {

														echo $con->descripcion . " " . "<span class='badge bg-success'>"  . $areas->name .  "</span>" . " " . "<span class='badge bg-primary'>"  . $averias->name .  "</span>";
													}
													?></td>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form method="post" id="addproduct_<?php echo $con->id; ?>" action="./?action=idoall&opt=update" role="form">
														...
														<script type="text/javascript">
															jQuery(document).ready(function() {
																...
																jQuery("#item_id_<?php echo $con->id; ?>").change(function() {
																	var selectedValue = jQuery(this).val();
																	jQuery("#name_<?php echo $con->id; ?>").val(selectedValue);
																});
															});
														</script>

														<div class="form-group">
															<label for="name_<?php echo $con->id; ?>">Clasificacion</label>
															<input type="text" name="clasificacion" value="<?php echo $con->clasificacion; ?>" class="form-control" id="name_<?php echo $con->id; ?>" placeholder="Categoria" disabled>
														</div>
														<div class="form-group">
													...
													<script type="text/javascript">
														jQuery(document).ready(function() {
															...
															jQuery("#addproduct_<?php echo $con->id; ?>").submit(function() {
																// Habilita el input antes de enviar el formulario
																jQuery("#name_<?php echo $con->id; ?>").prop("disabled", false);
															});
														});
													</script>
												</div>
				...
				<div class="col-12">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<form method="post" action="./?action=idoall&opt=update" id="classificationForm">
								<input type="hidden" name="_id" value="<?php echo $con->id; ?>">
								<div class="form-group">
									<label>Areas</label>
								...
								<script type="text/javascript">
									jQuery(document).ready(function() {
										...
										jQuery("#item_id").change(function() {
											var selectedValue = jQuery(this).val();
											jQuery("#name").val(selectedValue);
										});

										// Captura el evento de envío del formulario
										jQuery("#classificationForm").submit(function() {
											// Habilita el input antes de enviar el formulario
								...
								<div class="mb-3">
									...
									<input type="text" name="clasificacion" class="form-control" value="<?php echo $con->clasificacion; ?>" id="name" placeholder="Ingresa la Area" required disabled>
								</div>
