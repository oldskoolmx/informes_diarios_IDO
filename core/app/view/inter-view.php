...
if (isset($_GET["opt"]) && $_GET["opt"] == "all") :
	...
	$contacts = InterData::getAllg1($grupo);
?>
				...
				<div class="col-12">
					...
					<div class="card">
						<div class="card-header">
							<h1 class="">Interrupciones <?php echo $gerencia; ?></h1>
							<a href="./?view=inter&opt=new&g=<?php echo $grupo; ?>" class="btn btn-secondary">Nueva Interrupcion</a>
						</div>
						<div class="card-body">
										...
										<?php foreach ($contacts as $con) : ?>
											<tr>
												...
												<td style="width:190px; ">
													...
													<a href="./?action=inter&opt=del&id=<?php echo $con->id; ?>&g=<?php echo $grupo; ?>" id="item-<?php echo $con->id; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Eliminar</a>
				...
				<div class="col-12">
					...
					<div class="card">
						<div class="card-header">
							...
							<a href="./?view=inter&opt=all&g=<?php echo $grupo; ?>" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Regresar</a>
						</div>
						<div class="card-body">

							<form class="row g-3" method="post" action="./?action=inter&opt=add&g=<?php echo $grupo; ?>">
								...
								<div class="col-md-6 mb-3">
									...
									<?php
									$cats = CategoryData::getAllg($grupo);
									?>
									<?php if (count($cats) > 0) : ?>
