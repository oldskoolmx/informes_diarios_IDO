				...
				<div class="card">
					...
					<div class="card-body">
						<div>
							...
							<form>
								<input type="hidden" name="view" value="reportall">
							...
							if (isset($_GET["start_at"]) && $_GET["start_at"] != "" && isset($_GET["finish_at"]) && $_GET["finish_at"] != "") {
								...
								$usersT = OperationData::getByRange1T($_GET["start_at"], $_GET["finish_at"]);
								if (count($users) > 0 && count($usersT) > 0) {
									// si hay usuarios
											...
											?>
												<tbody>
															<tr>
																...
																<td><?php echo $user->uno_a_4; ?></td>
																<td><?php echo $user->uno; ?></td>
																<td><?php echo $user->cinco_a_14; ?></td>
																<td><?php echo $user->cinco; ?></td>
																<td><?php echo $user->quince_a_29; ?></td>
																<td><?php echo $user->quince; ?></td>
																<td><?php echo $user->mas_de_30; ?></td>
																<td><?php echo $user->mas; ?></td>
																<td><?php echo $user->T_eventos; ?></td>
																<td><?php echo $user->T_retardos; ?></td>
															</tr>
														</tbody>
									<?php
											
										}
											foreach ($usersT as $con) :
												?>
												<tfoot>
													<tr>
														<td>TOTAL</td>
											...
											echo "<p class='alert alert-danger'>No hay datos del  ".$_GET["start_at"]." al " .$_GET["finish_at"]."</p>";
										}
									} else {
